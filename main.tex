...
[placeholder][Anomaly detection in microservice environments using distributed tracing data analysis and NLP]\cite{kohyarnejadfard2022anomaly}
[placeholder][Anomaly Detection in Microservice-Based Systems]\cite{nobre2023anomaly}
